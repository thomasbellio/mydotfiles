...
INCUS_VM_NETWORK="172.25.0.0/24"
...
iptables -A FORWARD -s $INCUS_VM_NETWORK -o $WIRELESS_NETWORK_INTERFACE_NAME  -j ACCEPT
iptables -A FORWARD -s $INCUS_VM_NETWORK -o $WIRED_NETWORK_INTERFACE_NAME   -j ACCEPT
